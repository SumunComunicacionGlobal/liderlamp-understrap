...
<div class="adaptable-post">
	...
	<article <?php post_class( 'post-side d-none d-lg-block' ); ?> id="post-<?php the_ID(); ?>">

		<div class="row no-gutters">

			<div class="col-md-6 post-side-image">

				<?php echo get_the_post_thumbnail( $post->ID, 'medium_large' ); ?>

			</div>

			<div class="col-md-6 post-side-content px-2">
